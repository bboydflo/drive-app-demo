...
} else if (process.env.analize) {

  // add support for bundle analyzer
...
let webpackConfig = {
  ...
  module: {
    rules: [
      ...
      }, */
      {
        ...
        include: [
          PATHS.js,
          path.join(__dirname, 'node_modules', 'merge-options'),
          path.join(__dirname, 'node_modules', 'flagstrap-preact', 'src', 'js')
        ],
  ...
  resolve: {
    ...
    alias: {
      ...
      // 'tiny-pub-sub': path.resolve(__dirname, 'src', 'js', 'vendor', 'jquery-tinypubsub.min.js'),
    }
  },
