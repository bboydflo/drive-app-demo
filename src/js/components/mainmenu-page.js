...
export default (Backbone, broker, loginApi, utils, session) => {

  return class MainmenuPage extends Component {
    ...
    onItemClick = (ev) => {
      ...
      // get layout
      let layout = utils.getLayoutBy('requestKey', reqKey);
      ...
      Backbone.history.navigate(routePrefix + reqKey + routeSuffix, { trigger: true });
    }
  };
};
